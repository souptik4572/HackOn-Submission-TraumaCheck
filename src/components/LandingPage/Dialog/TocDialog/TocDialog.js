...
function TocDialog(props) {
  const { open, handleClose, setTocAccepted } = props;
    ...
    <div>
      ...
      >
        <DialogTitle id="customized-dialog-title" onClose={handleClose}>
          Terms and Conditions (Last updated: April 28, 2021)
        </DialogTitle>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to TraumaCheck.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to TraumaCheck, accessible from{" "}
                <a
...
export default connect(mapStateToProps, mapDispatchToProps)(TocDialog);
